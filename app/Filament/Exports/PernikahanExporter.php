...
class PernikahanExporter extends Exporter
{
    ...
    {
        $body = 'Your pernikahan export has completed and ' . number_format($export->successful_rows) . ' ' . str('row')->plural($export->successful_rows) . ' exported.';
